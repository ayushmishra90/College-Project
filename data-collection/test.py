...
#     count += 1
#     try:
#         print("Packet:", count, "Layers:", pkt.layers)
#     except:
#         pass

# cap.close()

# print("Total packets read:", count)
...
# # PCAP_DIR = "/tmp/"
# CSV_OUTPUT = "./flow_dataset_features.csv"
...
# #         continue
# pcap_file ="./h4_capture_benign_1.pcap"
